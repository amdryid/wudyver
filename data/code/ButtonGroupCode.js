...
`.trim();
export const PaginationsCode = [BasicButtonGroupCode, GroupLinksCode, MixedStylesCode, OutlineStylesCode, CheckboxStyleCode, RadioStyleCode, ToolbarStyleCode, ButtonSizingCode, ButtonNestingCode, VerticalButtonCode];
