...
`.trim();
export const ModalsCode = [SampleExamplesCode, LiveDemoCode, LongContentCode, ScrollableModalCode, VerticallyCenteredCode, TooltipsPopoversCode, OptionalSizesCode];
