...
`.trim();
export const NavsCode = [MenuNavCode, MenuNavFlexCode, AlignmentCenterCode, AlignmentRightCode, VerticalFlexCode, VerticalULLICode, TabsNavCode, PillsNavsCode, FillPillsULLICode, FillPillsLinkCode, FillPillsJustifyCode, NavsFlexUtilitiesCode, NavsTabsCode, NavsTabsPillsCode, VerticalPillsCode];
