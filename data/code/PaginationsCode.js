...
`.trim();
export const PaginationsCode = [DefaultPaginationCode, PaginationWithIconsCode, DisabledActiveCode, PaginationSizingCode, PaginationSizingSmallCode, AlignmentCode, JustifyContentEndCode];
